...
export class LessonController {
    constructor() {
        ...
        this.createLesson = async (req, res) => {
            try {
                const { courseId, title, content, video_url } = req.body;
                const lesson = await this.lessonService.createLesson(Number(courseId), title, content, video_url);
        ...
        this.getLessons = async (_req, res) => {
            try {
        ...
        this.getLessonById = async (req, res) => {
            try {
        ...
        this.updateLesson = async (req, res) => {
            try {
                const id = Number(req.params.id);
                const { title, content, video_url } = req.body;
                const lesson = await this.lessonService.updateLesson(id, title, content, video_url);
        ...
        this.deleteLesson = async (req, res) => {
            try {
                const id = Number(req.params.id);
