...
// Teacher Route
router.get("/teacher", authMiddleware, authorizeRoles("TEACHER"), (req: Request, res: Response) => {
  res.json({
...
// Student Route
router.get("/student", authMiddleware, authorizeRoles("STUDENT"), (req: Request, res: Response) => {
  res.json({
